...
import com.pm.patient_service.dto.validators.CreatePatientValidationsGroup;
...
public class PatientController {
    ...
    public ResponseEntity<PatientResponseDTO> createPatient(
            @Validated({Default.class, CreatePatientValidationsGroup.class}) @RequestBody PatientRequestDTO patientRequestDTO) {
